...
const demoFundraisers: Fundraiser[] = [
  ...
  },
  {
    id: "demo-4",
    slug: "demo-4",
    title: "Курс по монтажу и цветокору",
    categorySlug: "education",
    currentAmountMinor: 1200000,
    targetAmountMinor: 4000000,
    authorName: "Кирилл",
    authorUsername: "kirill",
  },
  {
    id: "demo-5",
    slug: "demo-5",
    title: "Студийный микрофон для эфиров",
    categorySlug: "electronics",
    currentAmountMinor: 3450000,
    targetAmountMinor: 9000000,
    authorName: "Мария",
  ...
  },
  {
    id: "demo-6",
    slug: "demo-6",
    title: "Велосипед для городских вылазок",
    categorySlug: "sport",
    currentAmountMinor: 2100000,
    targetAmountMinor: 7500000,
    authorName: "Дима",
    authorUsername: "dima",
  },
  {
    id: "demo-7",
    slug: "demo-7",
    title: "Швейная машинка для мастерской",
    categorySlug: "hobbies",
    currentAmountMinor: 980000,
    targetAmountMinor: 3200000,
    authorName: "Аня",
    authorUsername: "anya",
  },
  {
    id: "demo-8",
    slug: "demo-8",
    title: "Поездка на море с друзьями",
    categorySlug: "travel",
    currentAmountMinor: 15000000,
    targetAmountMinor: 24000000,
    authorName: "Настя",
    authorUsername: "nastya",
  },
];

...
**Цель:** поднять тестовый контур в российской инфраструктуре, применить 95 миграций, прогнать сценарии QA и войти в закрытую бета-фазу Будённовска. Ниже — точный порядок действий. Никаких секретов в чат: env заполняются только локально на сервере.
